<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a id="downlink"></a>
      <div style="margin-left: 8px" class="button" @click="uploadFile()">导入</div>
    </div>         
...
// import { getOptionList, chooseOption } from '@/api/smallpurchase'
  ...
  methods: {
    ...
    importFile: function () { // 导入excel
      ...
      reader.onload = function (e) {
        ...
        this.dealFile(this.analyzeData(json)) // analyzeData: 解析导入数据
      }
      if (this.rABS) {
